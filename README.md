# Make sure you have Python installed. You can install all the required dependencies via pip: pip install torch torchvision opencv-python numpy pillow matplotlib pandas
